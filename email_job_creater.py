...
class EmailJobCreater:
    def __init__(self):
        ...
        #信息文件中license名字是第几列（第一列是0）
        self.info_file_license_name_column_index = 1
        #信息文件中license数量是第几列（第一列是0）
        self.info_file_license_quantity_column_index = 2
        self.companies = []
    ...
    def create_email_jobs(self,email_file_path,info_file_path):
        excel_reader = ExcelReader(email_file_path,info_file_path)
                ...
                if days_difference> 0:
                    ...
                    for email_row_index in range(excel_reader.email_df.shape[0]):
                        ...
                        if company_code == target_company_code:
                            ...
                            license_name = excel_reader.info_df.iloc[info_row_index , self.info_file_license_name_column_index]
                            license_quantity = excel_reader.info_df.iloc[info_row_index , self.info_file_license_quantity_column_index]
